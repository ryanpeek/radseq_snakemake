...
rule all:
    input: 
        expand("outputs/split_fastq/{lane}_{plate}_{sample}_R{read}.fastq", lane = LANES, plate = PLATES, sample=SAMPLES, read = READS)
